<?php namespace App\Http\Controllers;
	...
	class AdminDocenteController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Nivel","name"=>"nivel","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:docente","placeholder"=>"Introduce una dirección de correo electrónico válida"];
			# OLD END FORM
	        ...
	        */
            $this->addaction = array(
                ['label'=>'Asignaturas','icon'=>'fa fa-table','color'=>'warning','url'=>CRUDBooster::mainpath('docente-asignatura').'/[id]']
            );
